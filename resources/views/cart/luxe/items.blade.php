    ...
    <div  v-for="item in items" class="items clearfix">
        <div id="cart-main-div" style="">
            <button style="z-index: 1" type="button" v-on:click="remove(item.id)"  :value="item.id" class="absolute close">
                ...
                <img id="item-image" style="" :src="item.attributes.image" :data-src="item.attributes.image"  class="productImage" alt="" width="60px" height="60px">
