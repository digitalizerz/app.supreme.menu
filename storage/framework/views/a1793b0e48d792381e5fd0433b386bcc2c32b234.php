    ...
    <?php if(config('app.isqrexact')): ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.restaurant.visits.index')); ?>">
                <i class="ni ni-calendar-grid-58 text-blue"></i> <?php echo e(__('Marketing')); ?>
...
<?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\resources\views/layouts/navbars/menus/owner.blade.php ENDPATH**/ ?>