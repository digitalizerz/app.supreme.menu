                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="alert alert-default">
                            <div class="row">
                                <div class="col">
                                    <a data-toggle="collapse" href="#myCollapseExample<?php echo e($loop->iteration); ?>" aria-expanded="false" aria-controls="myCollapseExample">
                                     <span class="h2 font-weight-bold mb-0 text-dark"> <i class="fa fa-bars pr-3"></i> <?php echo e($category->name); ?></span>
                                    </a>
                                </div>
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        ...
                                        <?php if($canAdd): ?>
                                            <button class="btn btn-icon btn-1 btn-sm btn-success" type="button" data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('Add item')); ?> in <?php echo e($category->name); ?>" onClick=(setSelectedCategoryId(<?php echo e($category->id); ?>)) >
                                                <span class="btn-inner--icon"><i class="fa fa-plus"></i></span>
                                            </button>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('plans.current')); ?>" class="btn btn-icon btn-1 btn-sm btn-warning" type="button"  >
                                                <span class="btn-inner--icon"><i class="fa fa-plus"></i> <?php echo e(__('Menu size limit reached')); ?></span>
                                            </a>
                                        <?php endif; ?>
                                        <button class="btn btn-icon btn-1 btn-sm btn-info" type="button" id="edit" data-toggle="modal" data-target="#modal-edit-category" data-toggle="tooltip" data-placement="top" title="<?php echo e(__('Edit category')); ?> <?php echo e($category->name); ?>" data-id="<?= $category->id ?>" data-name="<?= $category->name ?>" >
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <!-- UP -->
                                         <?php if($index!=0): ?>
                                            <a href="<?php echo e(route('items.reorder',['up'=>$category->id])); ?>"  class="btn btn-icon btn-1 btn-sm btn-reorder" >
                                        ...
                                        <?php if($index+1!=count($categories)): ?>
                                            <a href="<?php echo e(route('items.reorder',['up'=>$categories[$index+1]->id])); ?>" class="btn btn-icon btn-1 btn-sm btn-reorder">
                        ...
                        <?php endif; ?>
                        <?php if($category->active == 1): ?>
                        <div class="row justify-content-center collapse" id="myCollapseExample<?php echo e($loop->iteration); ?>">
                            <div class="col-lg-12">
                                                ...
                                                <div class="card">
                                                  <!--  <img class="card-img-top" src="<?php echo e($item->logom); ?>" alt="..."> -->
                                                    <div class="card-body p-2">
                                                        <h5 class="card-title text-primary text-uppercase mb-0"><?php echo e($item->name); ?></h5>
                                                      <!--  <p class="card-text description mt-3"><?php echo e($item->description); ?></p> -->
                                                        ...
                                                        <span class="mt-2 mb-0 text-sm card-item-price"><?php echo money($item->price, config('settings.cashier_currency'),config('settings.do_convertion')); ?></span>
                                                     </div>
                                                    </div>
                                                </div>
                                                <br/>
                                    ...
                                    <div class="col-lg-3" >
                                        <a   data-toggle="modal" data-target="#modal-new-item" data-toggle="tooltip" data-placement="top" href="javascript:void(0);" onclick=(setSelectedCategoryId(<?php echo e($category->id); ?>))>
                                            <div class="card add-item-card">
                                              <!--  <img class="card-img-top" src="<?php echo e(asset('images')); ?>/default/add_new_item.jpg" alt="..."> -->
                                                <div class="card-body">
                                                    <h5 class="card-title text-primary text-uppercase text-center text-white mb-0"><?php echo e(__('+ Add item')); ?></h5>
                                                </div>
                                            </div>
                                        </a>
                                        <br />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/items/index.blade.php ENDPATH**/ ?>