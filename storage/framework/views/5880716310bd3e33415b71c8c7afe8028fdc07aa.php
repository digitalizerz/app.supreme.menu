  ...
  <section id='header' class='header section-header bg-transparent border-0'>
      <div class='packer'>
          <div class='package'>
              <div class='left'>
                <a href='/<?php echo e($restorant->subdomain); ?>' class='d-flex align-items-center btn btn-link back-button'><svg width="12" fill="currentColor" viewBox="0 -23.1328 12.25 11.9218" xmlns="http://www.w3.org/2000/svg"><path d="M7.05-12.01c.12-.13.18-.29.17-.47 -.01-.19-.08-.34-.21-.47L3.72-16.1h7.84c.18 0 .33-.07.46-.2 .12-.13.19-.29.19-.47v-.88c0-.19-.07-.34-.2-.47 -.13-.13-.29-.2-.47-.2H3.69l3.28-3.15c.12-.13.19-.29.2-.47 0-.19-.06-.34-.18-.47l-.63-.61c-.13-.13-.29-.2-.47-.2 -.19 0-.34.06-.47.19l-5.31 5.3c-.13.12-.2.28-.2.46s.06.33.19.46l5.3 5.3c.12.12.28.19.46.19s.33-.07.46-.2Z"/></svg>&nbsp;&nbsp;<?php echo e(__('Back')); ?></a>
              </div>
              <div class='right'>
                  <nav id='menu'>
  ...
  </section><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/layouts/luxe/top.blade.php ENDPATH**/ ?>