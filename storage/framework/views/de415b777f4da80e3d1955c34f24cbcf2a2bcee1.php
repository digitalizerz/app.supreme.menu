                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group<?php echo e($errors->has('item_description') ? ' has-danger' : ''); ?>">
                                            ...
                                            <textarea id="item_description" name="item_description" class="form-control form-control-alternative<?php echo e($errors->has('item_description') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Item Description here ... ')); ?>" value="<?php echo e(old('item_description', $item->description)); ?>" autofocus rows="3"><?php echo e(old('item_description', $item->description)); ?></textarea>
                                        ...
                                        <?php echo $__env->make('partials.toggle',['id'=>'featured','name'=>'Featured','checked'=>($item->featured == 1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('partials.toggle',['id'=>'send_order_notification','name'=>'Enable order notification','checked'=>($item->send_order_notification==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('partials.toggle',['id'=>'pay_tru_menu','name'=>'Enable order payment','checked'=>($item->pay_tru_menu==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('partials.toggle',['id'=>'no_ordering','name'=>'Enable view item only','checked'=>($item->no_ordering==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/items/edit.blade.php ENDPATH**/ ?>