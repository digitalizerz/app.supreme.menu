            ...
            <div  class="card card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h6 class="font-weight-bold"><?php echo e($a_item->name); ?></h6>
                    </div>
                   <!--  <div class="col-12">
            ...
            <div class='content'>
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="btn_reserve_fixed"><a href="#0" class="btn_1 btn-black gradient full-width" id="theCartBottomButton" onClick="openNav()" ><?php echo e(__('Order Summary')); ?> </a></div>
                        <?php endif; ?>
...
</section><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\modules\LuxeTemplate\Providers/../Resources/views/templates/place-content.blade.php ENDPATH**/ ?>