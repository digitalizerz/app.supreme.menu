...
<?php echo $__env->make('restorants.partials.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(count($restorant->featured_items()) > 0): ?>
<section class=" pt-lg-0 mb--5" style="margin-bottom: 10px">
    <div class="container-fluid featured">
        <h4 class="font-weight-bold featured-items-title">FEATURED ITEMS</h4>
        <div class="d-flex flex-row flex-nowrap overflow-auto">
            <?php $__currentLoopData = $restorant->featured_items(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a onClick="setCurrentItem(<?php echo e($a_item->id); ?>)" href="javascript:void(0)">
            <div  class="card card-body">
                <div class="row">
                    <div class="col-12">
                        <img src="<?php echo e($a_item->logom); ?>" />
                        <p class="font-weight-bold"><?php echo e($a_item->name); ?></p>
                    </div>
                   <!--  <div class="col-12">
                        <p><?php echo e($a_item->name); ?></p>
                    </div> -->
                </div>
            </div>
                </a>
...
<?php if(isset($showGoogleTranslate)&&$showGoogleTranslate&&!$showLanguagesSelector): ?>
    ...
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/restorants/show.blade.php ENDPATH**/ ?>