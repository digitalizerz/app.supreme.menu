                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="post" action="<?php echo e(route('items.store')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group<?php echo e($errors->has('item_description') ? ' has-danger' : ''); ?>">
                                <textarea class="form-control" id="item_description" name="item_description" rows="3" placeholder="<?php echo e(__('Item description')); ?> ..." ></textarea>
                            ...
                            <?php echo $__env->make('partials.toggle',['id'=>'featured','name'=>'Featured','checked'=> ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                            <?php echo $__env->make('partials.toggle',['id'=>'itemAvailable','name'=>'Item available','checked'=> ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('partials.toggle',['id'=>'send_order_notification','name'=>'Enable order notification','checked'=> ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('partials.toggle',['id'=>'pay_tru_menu','name'=>'Enable order payment','checked'=> ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('partials.toggle',['id'=>'no_ordering','name'=>'Enable view item only','checked'=> ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/items/partials/modals.blade.php ENDPATH**/ ?>