              ...
              <?php echo $__env->make('cart.items', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php if(!config('settings.social_mode')): ?>
                    ...
                    <?php elseif(config('app.isqrsaas')&&count($timeSlots)>0): ?>
                      ...
                      <!-- Local Order Phone -->
                      <?php if(!$restorant->send_order_notification): ?>
...
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\resources\views/cart.blade.php ENDPATH**/ ?>