    ...
    <div class='box-info bg-white'>
        <div class="box-order">
            <div class='head align-center'>
                <h6><?php echo e(__('Order Summary')); ?> <br><small><?php echo e(__('Minimum order')); ?>  <?php echo money($restorant->minimum, config('settings.cashier_currency'),config('settings.do_convertion')); ?></small></h6>
            </div>
        </div>
        ...
        <div id="<?php echo e($idtotal); ?>">
            <div  v-if="totalPrice==0" class='empty-cart'>
                <p><small><?php echo e(__('Add something to order')); ?>!</small></p>
            </div>
...
</div><?php /**PATH C:\Users\Omen 1 Solutions\Desktop\WEBAPP-SUPREME\httpdocs\supreme.menu\modules\LuxeTemplate\Providers/../Resources/views/templates/side_cart.blade.php ENDPATH**/ ?>