...
class Items extends TranslateAwareModel
{
    ...
    protected $fillable = ['name', 'description', 'image', 'price','discounted_price', 'category_id', 'vat','enable_system_variants', 'send_order_notification', 'pay_tru_menu','no_ordering','featured'];
